...
import lesson07_media
import fresh_tomatoes

# Creating a object
godfather = lesson07_media.Movie("The Godfather",
...
et_the_terrestrial = lesson07_media.Movie("E.T. the Extra-Terrestrial",
...
print(lesson07_media.Movie.VALID_RATINGS) # Print the Class Variables

print(lesson07_media.Movie.__doc__) # Print the class documentation
